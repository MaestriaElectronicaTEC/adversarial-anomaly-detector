...
def Broadcast(name, dlatent_broadcast=10):
    def broadcast(x):
...
def StyleGAN_G_synthesis(dlatent_size=512, resolution=64):
    # General parameters
    num_channels = 3
...
class StyleGAN_G(Model):
    def __init__(self, resolution=64, latent_size=512, dlatent_size=512, mapping_layers=8, mapping_fmaps=512, mapping_lrmul=0.01 ):
...
class StyleGAN_D(Model):
    def __init__(self, resolution=64, mbstd_group_size=4, mbstd_num_features=1):
